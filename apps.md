...
<div class="columns" style="margin-top: 2rem;">
    ...
    <div class="column is-half-desktop is-full-tablet">
        <div class="box" style="height: 100%; text-align: center;">
            <h2 class="title is-2">Birdie Tracker</h2>
            ...
            <div style="margin: 2rem 0;">
                <a href="https://apps.apple.com/us/app/birdie-tracker/id[APP_ID]" 
                   ...
                   style="background-color: #5BA3F5; color: white; font-weight: 600; padding: 1rem 2rem; margin: 0.5rem;">
                    Download Birdie Tracker App for Free
                </a>
            </div>
            <p class="content" style="font-size: 0.9em; color: #666; margin-top: 1rem;">
                <a href="{{site.url}}{{site.baseurl}}/birdietracker-app">More Info</a> | 
                <a href="{{site.url}}{{site.baseurl}}/birdietracker/privacy">Privacy Policy</a> | 
                <a href="{{site.url}}{{site.baseurl}}/birdietracker/terms">Terms of Service</a>
            </p>
        </div>
    </div>
